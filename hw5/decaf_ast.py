...
# ========================================================================================================================================================================================
            ...
            for method_key, method_value in value["methods"].items():
                ...
                codegen.method(method_value["methodName"], method_key)
...
class Auto(Node):
    def __init__(self, post = None, pre = None, lhs = None):
        ...
        self.lhs = lhs
    def __str__(self):
        codegen.auto(self.pre, self.post, str(self.lhs))
        if (self.pre == "++"):
...
class Assign(Node):
    ...
    def __str__(self):
        ...
        codegen.assign(str(self.lhs), str(right), str(self.expr), self.expr)
